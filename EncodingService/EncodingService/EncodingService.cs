...
public class EncodingService: IEncoding
{
    ...
    public async Task<string> Encrypt(string text)
    {
        ...
        byte[] encryptedBytes = null;
        byte[] passwordBytes = Encoding.UTF8.GetBytes("EvENtUmONe!@dotkz");
    ...
    public async Task<string> Decrypt(string decryptedText)
    {
        try
        {
    ...
    public string EncryptionNormalizedEmail(string decryptedText)
    {
        if (decryptedText is not null)
        {
            var textToBytes = Encoding.UTF8.GetBytes(decryptedText.Trim());
            string encryptionText = Base32.Crockford.Encode(textToBytes, padding: true);
            //return decryptedText;
            return encryptionText;
        }
        else { return decryptedText; }
    }
